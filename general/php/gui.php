...
<html lang="en">
    ...
    <body>
        ...
        <input type="hidden" name="called_from" value="<?php echo $call;?>" required/></form></div><div class="col"> <!-- current cal l passed to next page will be that page's last call -->
        <?php ($dir === "UP") ? ($upind="../images/gui/uplit.png") : ($upind="../images/gui/upunlit.png");
        ($dir === "DOWN") ? ($downind="../images/gui/downlit.png") : ($downind="../images/gui/downunlit.png");?>
        <img src=<?php echo $upind?> width="100" alt="Up Arrow" title="Down Arrow"><br/> <!-- up indicator -->
        <img src=<?php echo $downind?> width="100" alt="Down Arrow" title="Down Arrow"><br/> <br/> <!-- down indicator -->
